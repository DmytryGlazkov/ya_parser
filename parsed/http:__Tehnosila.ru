...
<!-- End Google Tag Manager -->
    ...
    <div class="main-banners">
        ...
        <div id="halloween-timer">
            ...
            <script>jQuery(document).ready(function(){halloweenTimer(91850);});</script>
        </div>
        <div class="clear"></div>
    </div>
    <div class="clear"></div>
...
<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"beacon-5.newrelic.com","licenseKey":"38b07c05cc","applicationID":"4788586","transactionName":"blwHZ0dQV0ZYWhJRXFcWJFBBWFZbFmoPTFZ6VgtHR15VWVxLSVFdXVwd","queueTime":0,"applicationTime":333,"ttGuid":"","agentToken":"","atts":"QhsEEQ9KREg=","errorBeacon":"bam.nr-data.net","agent":"js-agent.newrelic.com\/nr-476.min.js"}</script></body>
</html>
