...
<title>Поиск работы, вакансии |  Единый поиск. Все вакансии. Indeed</title>
<meta name="description" content="Indeed это поисковик вакансий. Единый поиск. Все вакансии. Найдите работу с помощью Indeed, самым исчерпывающим и бесплатным сервисом поиска работы в Интернете.">
<meta name="keywords" content="поиск работы, Indeed, вакансии, сайт вакансий, поиск работы в интернете, список вакансий, найти вакансию, карьера, трудоустройство, работа, найти работу, вакансии rss ">
...
#rsj { padding: 0 2em 4px 0;  border-bottom: 1px solid #DEDFEE }
.rsi { padding: 3px 0; }
...
.inwrap { border-right: 1px solid #e8e8e8;border-bottom: 1px solid #e8e8e8;display:inline-block; margin-right: -1px;}
...
#viewport { min-height:100%; _height: 100%; position: relative; }
.content { padding-bottom: 34px;}
.footer { position: absolute; height: 34px; width: 100%; left: 0; bottom: 0; }
#footerMainLinks { float: left; margin: 9px; margin-left: 12px; _margin-left: 6px;  text-align: left; font-size: 9pt; white-space:nowrap; }
#footerLegal { text-align: right; margin: 9px; margin-right: 12px; margin-top: 9px !important; white-space: nowrap; font-size: 9pt; }
.footerSpacing,
#footerBoilerplate,
.footerBreak,
.gajui,
.footer #cookie-alert { display: none; }

#gajui { margin: 3em 0 1em; text-align: center; }
#cookie-alert { margin-top: 3em !important; }



.cntryClip { overflow:hidden; height: 92px; margin-bottom: 17px }
...
var href = '/rpc/log?a=jserr&tk=196bfprur16t22rk&msg=' + urlencode( msg ) + '&url=' + urlencode( url ) + '&line=' + urlencode( line );
...
function ptk(st,p) {
document.cookie = 'PTK="tk=196bfprur16t22rk&type=hp&subtype='+st+(p?'&'+p:'')+'"; path=/';
}
...
if(window.frames['pc']==null){
var fm=document.createElement('iframe');
fm.name='pc';
fm.style.display='none';
fm.src='/precache.html';
document.body.appendChild(fm);
}


window.initLogInitialUserInteraction('196bfprur16t22rk', 'hp');
}
...
<div id="p_nav"><span class="navBi"><a href="/" title="Вакансии" id="jobsLink" class="selected">Поиск вакансий</a></span><span class="navBi"><a href="https://ads.indeed.com/?hl=ru&cc=RU" id="empLink"  onclick="if ( this.href.match('&isid=employerlink-RU-control&ikw=hometop') == null ) { this.href += '&isid=employerlink-RU-control&ikw=hometop' };" >Работодатели / Разместить вакансию (бесплатно)</a></span></div>
...
<span class="navBi"><span id="navpromo"><a href="/promo/resume" onclick="window.location=this.href + '?from=nav&subfrom=rezprmstd&trk.origin=homepage&trk.variant=rezprmstd&trk.tk=196bfprur16t22rk'; return false;">Разместить Резюме</a></span></span>
...
<span class="navBi"><a href="http://ru.indeed.com/account/login?dest=%2F" rel="nofollow" id="userOptionsLabel">Войти</a></span>
...
<div class="content">
<table width=700 border=0 cellspacing=0 cellpadding=0 align=center style="margin-top:1em">
<tr>
<td>
<div class="cntryClip">


<img border=0 width=250 height=109 src="/images/job_search_indeed_2_ru_RU.png" alt="Поиск работы на Indeed"" title="Поиск работы на Indeed"">
...
<tr>
<td>
<form action="/jobs" method=get name=jobsearch id=jobsearch onsubmit="ptk('form')">
<table cellspacing=0 cellpadding=3 width="100%" align=center>
<tr>
<td class=npb><label for=what>что</label></td>
<td class=npb colspan=2><label for=where>где</label></td>
</tr>



<tr>
<td class="npl epr"><span class=inwrap><input class=input_text maxlength=512 size=31 id=what name=q  ></span><div style="width:250px"><!-- --></div></td>
<td class="npl epr"><span class=inwrap><input class=input_text maxlength=64 size=27 id=where name=l  ></span><div style="width:200px"><!-- --></div></td>
<td class=npl style="width:1px"><span class="inwrapBorder" style="width:auto;"><span class="inwrapBorderTop"><input id=fj type=submit class=input_submit  value="Поиск вакансий"></span></span></td>
</tr>
...
<tr valign=baseline>
<td class=label><label for="what">должность, название компании или ключевые слова</label></td>
<td class=label><label for="where">город или регион</label></td>
<td style="padding-top:0"><a class="sl" href="/advanced_search">Расширенный поиск вакансий</a></td>
</tr>
</table>
</form>
...
<!-- Logging serverside -->
<p id="resPromoDisplay" class="resPromo"><a href="/promo/resume" onmousedown="this.href = appendParamsOnce( this.href, '?from=hp&subfrom=rezprmstd&trk.origin=homepage&trk.variant=rezprmstd&trk.tk=196bfprur16t22rk')"><b>Разместить резюме</b></a> - займет всего несколько секунд
</p>
...
el.parentNode.insertBefore(s, el);
                ...
                <script type="text/javascript">
                    loadJSAsync('/s/22476aa/jobsearch-all-compiled_ru.js')
                </script>
...
<div id="hp_welcome_message" style="text-align:center;margin:1.25em 0 0.4em">

301 345  свежих <a href="/jobs">вакансий</a> за 7  прошедших дней<br>
Поиск по сайтам поиска работы и кадровых агентств, в газетах и разделах «Требуются» на корпоративных сайтах.
...
<br><br><br><br><hr class=hr size=1>
</div>
...
<br/>
<div align="center" class="footer" style="clear:both">
...
<div id="footerMainLinks">
    ...
    <a href="/browsejobs">Просмотреть вакансии</a> - 
    ...
    <a href="/intl/ru/about.html"><nobr>О проекте</nobr></a>
...
<div>
    ...
    <div id="footerLegal"><span id="footerBoilerplate">&copy;2014 Indeed - </span><a href="/legal" class="sl">Использование Cookies, Конфиденциальность, и Условия</a></div>
    </div>
</div>
...
<script type="text/javascript">
<!--
(function ( tk ) { if ( tk && document.images ) { var s="/", q="?", a="&", e="="; (new Image()).src=s+"rpc"+s+"log"+q+"a"+e+"hpjsv"+a+"tk"+e+tk+a+"zr"+e+Math.floor(Math.random()*2147483647); } })('196bfprur16t22rk');
//-->
</script>
...
_comscore.push({ c1: "2", c2: "6486505", c4:"ru.indeed.com/", c15:"196bfpruq16t269c"});
(function() { var s = document.createElement("script"), el = document.getElementsByTagName("script")[0]; s.async = true; s.src = (document.location.protocol == "https:" ? "https://sb" : "http://b") + ".scorecardresearch.com/beacon.js"; el.parentNode.insertBefore(s, el); })();
</script>
<noscript>
<img src="http://b.scorecardresearch.com/p?c1=2&c2=6486505&c4=ru.indeed.com%2F&c15=196bfpruq16t269c&cv=2.0&cj=1" style="display:none" width="0" height="0" alt=""/>
</noscript>
