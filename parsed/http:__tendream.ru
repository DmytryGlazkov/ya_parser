...
<head>
    ...
    <title>�������� ��� tendream.ru</title>
</head>
<body>	
	<div class="wrap">
		
		<div id="title">
			<h1>�������� ���  <strong>tendream.ru</strong></h1>
		</div>
...
���� � ��� ���� ���������� �����������?<br>
          ...
          ����������� ����� ����� ����� �������� �����!<br>
			...
			<div class="side">
				<h3>��������� ����������� �� ������ <strong>tendream.ru</strong> ��� ���������:</h3>
                ...
                <form action="send_email.php" method="post" id="contactForm">
                    ...
                    <div>
                		<textarea cols="40" rows="8" name="message" class="form required" id="message" placeholder="���� ����������� �� ��������� ����� tendream.ru"></textarea>
                	</div>
                    <div>
                        ������� ��� � ��������
                        <input type=text value="" name=code class="form captcha required" style="vertical-align: baseline;float: none;">
                        <img src='/captcha.php?_CAPTCHA&amp;t=0.40817200+1415564130' style="height: 42px;vertical-align: bottom;">
                    </div>
                	<div class="oh">
